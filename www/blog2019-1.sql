...
--
-- Хост: 127.0.0.1
-- Время создания: Май 06 2019 г., 15:02
...
--
-- База данных: `blog2019`
--
CREATE DATABASE `blog2019` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `blog2019`;
...
INSERT INTO `node` (`node_id`, `title`, `body`, `annot`, `created`) VALUES
(1, 'Post 1', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.', '2019-04-29 13:22:17'),
(2, 'Post 2', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.', '2019-04-29 13:22:19'),
(3, 'Post 3', 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.', 'At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores.', '2019-05-06 08:32:41');
--
...
('def', 'blog2019', 'node', 'node_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'blog2019', 'node', 'title', 2, NULL, 'NO', 'tinytext', 255, 255, NULL, NULL, 'utf8', 'utf8_general_ci', 'tinytext', '', '', 'select,insert,update,references', ''),
('def', 'blog2019', 'node', 'body', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'blog2019', 'node', 'annot', 4, NULL, 'NO', 'mediumtext', 16777215, 16777215, NULL, NULL, 'utf8', 'utf8_general_ci', 'mediumtext', '', '', 'select,insert,update,references', ''),
('def', 'blog2019', 'node', 'created', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
...
('def', 'test', 'node', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'node', 'body', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'node', 'created', 3, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', ''),
('def', 'test', 'qq', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'qq', 'qqq', 2, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', '');
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '0'),
('HANDLER_READ_FIRST', '234'),
('HANDLER_READ_KEY', '192'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '44'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '67'),
('HANDLER_READ_RND_NEXT', '5195'),
('HANDLER_ROLLBACK', '2'),
('HANDLER_SAVEPOINT', '0'),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '103'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '3999'),
('INNODB_BUFFER_POOL_READS', '253'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '540'),
('INNODB_DATA_FSYNCS', '54'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '8425472'),
('INNODB_DATA_READS', '391'),
('INNODB_DATA_WRITES', '147'),
('INNODB_DATA_WRITTEN', '3430400'),
('INNODB_DBLWR_PAGES_WRITTEN', '103'),
('INNODB_DBLWR_WRITES', '10'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '100'),
('INNODB_LOG_WRITES', '25'),
('INNODB_OS_LOG_FSYNCS', '34'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '50688'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '12'),
('INNODB_PAGES_READ', '252'),
('INNODB_PAGES_WRITTEN', '103'),
...
('INNODB_ROWS_INSERTED', '9'),
('INNODB_ROWS_READ', '209'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '5982'),
('UPTIME_SINCE_FLUSH_STATUS', '5982');
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'W:\\usr\\local\\mysql-5.5\\share\\'),
...
('PID_FILE', 'W:\\usr\\local\\mysql-5.5\\data\\CR03364.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'W:\\usr\\local\\mysql-5.5\\data\\CR03364.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'W:\\usr\\local\\mysql-5.5\\data\\CR03364.err'),
...
('PLUGIN_DIR', 'W:\\usr\\local\\mysql-5.5\\lib\\plugin\\'),
...
('SLOW_QUERY_LOG_FILE', 'W:\\usr\\local\\mysql-5.5\\data\\CR03364-slow.log'),
...
('def', 'blog2019', 'PRIMARY', 'def', 'blog2019', 'node', 'node_id', 1, NULL, NULL, NULL, NULL),
...
('def', 'test', 'PRIMARY', 'def', 'test', 'node', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'qq', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-05-06 11:02:47', '2019-05-06 11:02:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-05-06 11:02:47', NULL, NULL, NULL, '', '', NULL),
('def', 'blog2019', 'node', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2019-05-06 09:27:16', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 440, 2200, 123848989752688639, 5120, 0, '2012-05-15 12:23:04', '2019-05-06 09:26:03', '2012-05-15 12:23:07', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-05-15 12:23:05', '2012-05-15 09:23:06', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 877, 445664, 281474976710655, 20480, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-05-15 12:23:05', '2012-05-15 09:23:06', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-05-15 12:23:07', '2012-05-15 09:23:08', '2012-05-15 12:23:07', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 67, 528, 281474976710655, 2048, 192, '2012-05-15 12:23:04', '2019-05-06 09:27:09', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_bookmark', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_column_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_designer_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_history', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_pdf_pages', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 368, 368, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-05-06 09:27:36', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_coords', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_info', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_table_uiprefs', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 4096, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_tracking', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, NULL, '', '', NULL),
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 56, 56, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2015-11-26 22:07:38', NULL, NULL, '', '', NULL),
('def', 'test', 'node', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2019-05-06 09:18:55', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'qq', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2019-05-06 09:18:55', NULL, NULL, NULL, '', '', NULL);
...
(237, 'root', 'localhost:50994', 'blog2019', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(236, 'root', 'localhost:50993', NULL, 'Sleep', 5, '', NULL);
...
('def', 'blog2019', 'utf8', 'utf8_general_ci', NULL),
...
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'SELECT', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'INSERT', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'UPDATE', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'DELETE', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'CREATE', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'DROP', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'REFERENCES', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'INDEX', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'ALTER', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'CREATE TEMPORARY TABLES', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'LOCK TABLES', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'EXECUTE', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'CREATE VIEW', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'SHOW VIEW', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'CREATE ROUTINE', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'ALTER ROUTINE', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'EVENT', 'YES'),
('''blog2018_user''@''localhost''', 'def', 'blog2018', 'TRIGGER', 'YES'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'SELECT', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'INSERT', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'UPDATE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'DELETE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'CREATE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'DROP', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'REFERENCES', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'INDEX', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'ALTER', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'CREATE TEMPORARY TABLES', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'LOCK TABLES', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'EXECUTE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'CREATE VIEW', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'SHOW VIEW', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'CREATE ROUTINE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'ALTER ROUTINE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'EVENT', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'blog2019', 'TRIGGER', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'SELECT', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'INSERT', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'UPDATE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'DELETE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'CREATE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'DROP', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'INDEX', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'ALTER', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'CREATE TEMPORARY TABLES', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'EXECUTE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'CREATE VIEW', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'SHOW VIEW', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'CREATE ROUTINE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'ALTER ROUTINE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'EVENT', 'NO'),
('''db2015_user''@''localhost''', 'def', 'db2015', 'TRIGGER', 'NO'),
('''''@''%''', 'def', 'test', 'SELECT', 'NO'),
('''''@''%''', 'def', 'test', 'INSERT', 'NO'),
('''''@''%''', 'def', 'test', 'UPDATE', 'NO'),
('''''@''%''', 'def', 'test', 'DELETE', 'NO'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '4062'),
('INNODB_BUFFER_POOL_READS', '253'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '540'),
('INNODB_DATA_FSYNCS', '54'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '5985'),
('UPTIME_SINCE_FLUSH_STATUS', '5985');
...
('def', 'blog2019', 'node', 0, 'blog2019', 'PRIMARY', 1, 'node_id', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'test', 'node', 0, 'test', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'qq', 0, 'test', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:50', '2019-05-06 11:02:50', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:50', '2019-05-06 11:02:50', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-05-06 11:02:50', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:50', '2019-05-06 11:02:50', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:50', '2019-05-06 11:02:50', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:51', '2019-05-06 11:02:51', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:51', '2019-05-06 11:02:51', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:51', '2019-05-06 11:02:51', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:51', '2019-05-06 11:02:51', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-05-06 11:02:51', '2019-05-06 11:02:51', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-05-06 11:02:51', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'blog2019', 'node', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 8388608, 4, '2019-05-06 09:27:16', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 5, 440, 2200, 123848989752688639, 5120, 0, NULL, '2012-05-15 12:23:04', '2019-05-06 09:26:03', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:05', '2012-05-15 09:23:06', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 877, 445664, 281474976710655, 20480, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:08', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-05-15 12:23:05', '2012-05-15 09:23:06', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-05-15 12:23:07', '2012-05-15 09:23:08', '2012-05-15 12:23:07', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-05-15 12:23:04', '2012-05-15 09:23:04', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 67, 528, 281474976710655, 2048, 192, NULL, '2012-05-15 12:23:04', '2019-05-06 09:27:09', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'phpmyadmin', 'pma_bookmark', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Bookmarks'),
('def', 'phpmyadmin', 'pma_column_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Column information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_designer_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Table coordinates for Designer'),
('def', 'phpmyadmin', 'pma_history', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'SQL history for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_pdf_pages', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, 1, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'PDF relation pages for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 368, 368, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-05-06 09:27:36', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
('def', 'phpmyadmin', 'pma_relation', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Relation table'),
('def', 'phpmyadmin', 'pma_table_coords', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Table coordinates for phpMyAdmin PDF output'),
('def', 'phpmyadmin', 'pma_table_info', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Table information for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_table_uiprefs', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 4096, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, '', 'Tables'' UI preferences'),
('def', 'phpmyadmin', 'pma_tracking', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2012-06-11 21:55:26', NULL, 'utf8_bin', NULL, 'row_format=COMPACT', 'Database changes tracking for phpMyAdmin'),
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 56, 56, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2015-11-26 22:07:38', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin'),
('def', 'test', 'node', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 3, '2019-05-06 09:18:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'test', 'qq', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 8388608, 3, '2019-05-06 09:18:55', NULL, NULL, 'utf8_general_ci', NULL, '', '');
...
('def', 'blog2019', 'PRIMARY', 'blog2019', 'node', 'PRIMARY KEY'),
...
('def', 'test', 'PRIMARY', 'test', 'node', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'qq', 'PRIMARY KEY');
...
('''blog2018_user''@''localhost''', 'def', 'USAGE', 'NO'),
('''blog2019_user''@''localhost''', 'def', 'USAGE', 'NO'),
('''db2015_user''@''localhost''', 'def', 'USAGE', 'NO'),
('''qq_user''@''localhost''', 'def', 'USAGE', 'NO'),
...
('localhost', 'blog2018', 'blog2018_user', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'db2015', 'db2015_user', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'N', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'blog2019', 'blog2019_user', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
('localhost', 'blog2019_user', '*00A51F3F48415C7D4E8908980D443C29C69B60C9', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
...
('root', '[{"db":"blog2019","table":"node"},{"db":"mysql","table":"user"},{"db":"blog2018","table":"node"},{"db":"blog2018","table":"user"},{"db":"db2015","table":"node"},{"db":"db2015","table":"user"},{"db":"blog2017","table":"user"},{"db":"test","table":"qq"},{"db":"test","table":"node"},{"db":"blog2015","table":"node"}]');
...
('root', '2015-11-26 22:07:35', '{"lang":"ru","collation_connection":null}');
--
-- База данных: `test`
--
...
INSERT INTO `node` (`id`, `body`, `created`) VALUES
(1, 'dsfsdfsdfsdfsdf fgsgfdsffsdfsdf', '2017-03-27 11:24:49'),
(2, 'sdfsfdsfsdf', '2017-03-27 11:24:58');

-- --------------------------------------------------------

--
-- Структура таблицы `qq`
--

CREATE TABLE IF NOT EXISTS `qq` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `qqq` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;

--
-- Дамп данных таблицы `qq`
--

INSERT INTO `qq` (`id`, `qqq`) VALUES
(1, '2017-03-27 11:27:28'),
(2, '2017-03-27 11:27:33');
